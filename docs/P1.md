...
**Revision:** 2026-08-18 (overlay IPv4 batch + POST 32/512; Prysm-bound follow-the-chain; ~17:28Z authorized `.45` `restart-beacon` restored overlay DHT TCP / `Processing blocks` while EL stayed `0x0`; separate lab UDP/DHT comms in [P2.md](./P2.md) does not close this gate)
