...
# Public advertise until conet-l0d owns a live L0 stream. Overlay vIP is 100.64.0.6.
...
start)
	...
	echo "Overlay advertise needs a live L0 stream before ADVERTISE_IP=100.64.0.6."
	;;
stop)
	stop_clients
	;;
